...
def india_map_coloring():
    ...
    cons = {
        ...
        "Andhra Pradesh": ["Karnataka", "Tamil Nadu", "Telangana", "Odisha", "Chhattisgarh"],
        "Arunachal Pradesh": ["Assam", "Manipur"],
        "Assam": ["Arunachal Pradesh", "Manipur", "Nagaland", "Meghalaya", "West Bengal", "Mizoram", "Tripura"],
        "Bihar": ["Jharkhand", "Uttar Pradesh", "West Bengal"],
        "Chandigarh": ["Haryana", "Punjab"],
        "Chhattisgarh": ["Madhya Pradesh", "Odisha", "Jharkhand", "Uttar Pradesh", "Maharashtra", "Telangana"],
        "Dadra and Nagar Haveli and Daman & Diu": ["Maharashtra", "Gujarat"],
        "Goa": ["Maharashtra", "Karnataka"],
        "Gujarat": ["Maharashtra", "Madhya Pradesh", "Rajasthan"],
        "Haryana": ["Rajasthan", "Uttar Pradesh", "Punjab", "Chandigarh", "Uttarakhand"],
        "Himachal Pradesh": ["Jammu & Kashmir", "Punjab", "Uttarakhand", "Ladakh", "Haryana"],
        "Jammu & Kashmir": ["Himachal Pradesh", "Ladakh", "Punjab", "Ladakh"],
        "Jharkhand": ["Bihar", "Chhattisgarh", "Odisha", "West Bengal", "Uttar Pradesh"],
        "Karnataka": ["Andhra Pradesh", "Maharashtra", "Tamil Nadu", "Telangana", "Goa", "Kerala"],
        "Kerala": ["Tamil Nadu", "Karnataka", "Lakshadweep"],
        ...
        "Odisha": ["Andhra Pradesh", "Chhattisgarh", "Jharkhand", "West Bengal", "Telangana"],
        ...
        "Uttar Pradesh": ["Bihar", "Haryana", "Madhya Pradesh", "Rajasthan", "Uttarakhand", "Himachal Pradesh"],
        "Uttarakhand": ["Himachal Pradesh", "Uttar Pradesh", "Haryana"],
        "West Bengal": ["Assam", "Jharkhand", "Sikkim", "Bihar", "Odisha"]
    }
    csp = CSP(vars, doms, cons)
    return csp.backtrack_search()
